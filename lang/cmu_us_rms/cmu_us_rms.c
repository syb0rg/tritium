...
cst_voice *register_cmu_us_rms(const char *voxdir)
{
    ...
    tritium_featSetString(vox->features,"name","cmu_us_rms");
    ...
    tritium_featSet(vox->features,"cg_db",cg_db_val(&cmu_us_rms_cg_db));
    tritium_featSetInt(vox->features,"sample_rate",cmu_us_rms_cg_db.sample_rate);
