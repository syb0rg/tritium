			 ...
			 const char *bo, int sample_rate)
{
	...
	if ((CST_LITTLE_ENDIAN && streq(bo, BYTE_ORDER_BIG))
	    || (CST_BIG_ENDIAN && streq(bo, BYTE_ORDER_LITTLE)))
